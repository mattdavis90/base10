...
class TestMetricHelper:
    ...
    def test_metric_helper_kwargs(self):
        ...
        metric = MetricHelper(name=alternative_name, fields=alternative_fields, metadata=alternative_metadata, **alternative_values)
...
class TestMetricHandler:
    ...
    def test_metric_handler_read_from_write_only(self):
        ...
        assert 'Attempt to read from a write-only MetricHandler' in str(exc.value)
